...
{
    /// <summary>
    /// maximum displacement allowed per move
    /// </summary>
    public float MAX_CLAMP = 0.05f;
    public InputController avatarInputController;
    public List<Renderer> renderers;

    [Header("God Object collision param")]
    public float maximalDisplacementUnity;
    ...
    RaquetteCollider infoCollision;
    ...
    private Vector3 ClampDisplacement(Vector3 displacementVector)
    {
