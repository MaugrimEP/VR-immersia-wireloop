...
public partial class VirtuoseAPI
{
    ...
    private const string DLLNAME = "VirtuoseAPI";
    ...
    /// </summary>
    /// <param name="VC">The VC parameter corresponds to a VirtContext object returned by the virtOpen function.</param>
    /// <param name="force">The force_p_bm_r_pm parameter contains the force to be applied. It is expressed in the form of a dynamic tensor with 6 components, with respect to the Virtuose endeffector and expressed in the coordinates of the base frame.</param>
    /// <returns>In case of success, the virtAddForce function returns 0. Otherwise, it returns -1 and the virtGetErrorCode function gives access to an error code.</returns>
